...
eosUL2016APV = "/eos/cms/store/group/phys_egamma/tnpTuples/rasharma/2021-02-10/UL2016preVFP/merged/"
eosUL2016 = "/eos/cms/store/group/phys_egamma/tnpTuples/rasharma/2021-02-10/UL2016postVFP/merged/"
...
UL2016_preVFP = {
    ...
    'DY_madgraph': tnpSample(
        'DY_madgraph',
        eosUL2016APV + 'DY_LO_L1matched.root',
        isMC = True, nEvts =  -1 
    ),
    ...
    'data_Run2016B': tnpSample(
        'data_Run2016B', 
        eosUL2016 + 'Run2016B_L1matched.root', 
        lumi = 0.030493962 + 5.879330594
    ),
    'data_Run2016C': tnpSample(
        'data_Run2016C', 
        eosUL2016 + 'Run2016C_L1matched.root', 
        lumi = 2.64992914
    ),
    'data_Run2016D': tnpSample(
        'data_Run2016D', 
        eosUL2016 + 'Run2016D_L1matched.root', 
        lumi = 4.292865604
    ),
    'data_Run2016E': tnpSample(
        'data_Run2016E', 
        eosUL2016 + 'Run2016E_L1matched.root', 
        lumi = 4.185165152
    ),
    'data_Run2016F': tnpSample(
        'data_Run2016F', 
        eosUL2016 + 'Run2016F_L1matched.root', 
        lumi = 2.725508364
    ),
}
...
UL2016_postVFP = {
    ...
    'data_Run2016F_postVFP': tnpSample(
        ...
        eosUL2016 + 'Run2016F_L1merged.root',
        lumi = 0.414987426
    ),
    'data_Run2016G': tnpSample(
        'data_Run2016G',
        eosUL2016 + 'Run2016G_L1matched.root',
        lumi = 7.634508755
    ),
    'data_Run2016H': tnpSample(
        'data_Run2016H', 
        eosUL2016 + 'Run2016H_L1matched.root', 
        lumi = 8.802242522
    ),
}
